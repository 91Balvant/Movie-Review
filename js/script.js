...
let upcoming = `https://api.themoviedb.org/3/trending/all/day?api_key=${api_key}`;
const Latest_Trailers_bg = document.querySelector('.Latest_Trailers');
const trailer_yt = document.querySelector('.trailer_yt');
const top_rated_url = `${base_url}/movie/${now_playing}?api_key=${api_key}&page=1`
...
const close_me = document.querySelector('.close_me');
